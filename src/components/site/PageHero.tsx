...
export function PageHero({
  ...
  return (
    <section className="relative bg-plum-deep text-cream overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28 grid lg:grid-cols-12 gap-10 items-center">
        <div className={image ? "lg:col-span-7" : "lg:col-span-12"}>
          ...
          {children && <div className="mt-8 max-w-2xl text-lg text-cream/80 leading-relaxed">{children}</div>}
        </div>
        {image && (
