      ...
      data={{
        ...
        whatWeDo: {
          ...
          paragraphs: [
            ...
            "Menopause awareness is especially important in workplaces as women between the ages of 45-55 form one of the fastest growing segments of the global workforce. According to the World Health Organization, many women experience symptoms during menopause that can affect their physical, emotional, and social well-being, including their professional lives. Research also shows that severe menopausal symptoms can contribute to reduced productivity, increased sick leave, and early retirement if adequate support is not available.",
        ...
        impact: {
          ...
          stats: [
            ...
            { num: "2023", label: "Future Generali outreach" },
            { num: "45-55", label: "Menopause focus age" },
          ],
          paragraphs: [
            ...
            "In 2023, SNHP further expanded its workplace outreach by conducting wellness and menstrual health seminars at Future Generali, focusing on healthy lifestyle practices, menstrual wellness, and menopause awareness in professional environments.",
