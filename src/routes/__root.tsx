...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Periods without pain, shame, or silence — powered by action and gender-neutral conversations." },
      { name: "author", content: "Safe n' Happy Periods" },
